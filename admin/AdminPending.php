...
<head>
    ...
    <title>Pending Accounts - Admin Panel</title>
...
<body class="bg-gray-50 text-gray-800 font-sans h-screen flex flex-col overflow-hidden">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900">Pending Accounts</h1>
                <p class="text-gray-500 mt-1">Accounts waiting for verification (1)</p>
            </div>

            <div class="flex flex-col gap-4">
                
               <a href="AdPendingDetail.html" class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center justify-between cursor-pointer hover:shadow-md hover:border-indigo-200 transition-all duration-200 group block">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h4 class="font-bold text-gray-900 group-hover:text-indigo-600 transition-colors">Phan Nguyễn Thảo Như</h4>
            <div class="flex items-center gap-4 text-sm text-gray-500 mt-1">
                <span>524v0007@student.tdtu.edu.vn</span>
                <span>0123456569</span>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center gap-6">
        <div class="text-right">
            ...
            <div class="text-xs text-gray-400 mt-1.5">5/7/2026</div>
        </div>
