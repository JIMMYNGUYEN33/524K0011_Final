...
<head>
    ...
    <title>Disabled Accounts - Admin Panel</title>
...
<body class="bg-gray-50 text-gray-800 font-sans h-screen flex flex-col overflow-hidden">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-500 mt-1">Inactive disabled accounts (1)</p>
            </div>

            <div class="flex flex-col gap-4">
                
                <a href="AdDisabledDetail.html" class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center justify-between cursor-pointer hover:shadow-md hover:border-red-200 transition-all duration-200 group block">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h4 class="font-bold text-gray-900 group-hover:text-red-600 transition-colors">Phan Nguyễn Thảo Như</h4>
            <div class="flex items-center gap-2 text-sm text-gray-500 mt-1">
                <span>baduser@gmail.com</span>
                <span>•</span>
    ...
    <div class="flex items-center gap-6">
        <div class="text-right">
            <div class="text-sm font-bold text-gray-400 mb-1.5 strike-through">0 VND</div>
        ...
        <i class="fa-solid fa-chevron-right text-gray-300 group-hover:text-red-500 transition-colors"></i>
    </div>
