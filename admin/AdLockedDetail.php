...
<head>
    ...
    <title>Locked Account Details - Admin Panel</title>
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <aside class="w-64 bg-white shadow-md flex flex-col overflow-y-auto z-0 shrink-0">
            <nav class="flex-1 py-4">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="AdminLocked.php" class="menu-item flex items-center gap-3 px-6 py-3 bg-indigo-50 text-indigo-600 font-medium">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            <div class="mb-6 flex items-center justify-between">
                <a href="AdminLocked.php" class="inline-flex items-center gap-2 text-indigo-600 hover:text-indigo-800 font-medium transition-colors">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-6">
                ...
                <div class="bg-orange-500 p-8 flex items-center gap-6 text-white">
                    ...
                    <div>
                        ...
                        <p class="text-orange-100 text-sm mt-1">ID: <?= h($user['id']) ?></p>
                    </div>
                </div>
                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-2 gap-y-6 gap-x-12 pt-8">
                        ...
                        <div>
                            ...
                            <span class="inline-flex items-center gap-1 bg-orange-100 text-orange-700 text-xs font-semibold px-2.5 py-1 rounded-full mt-1">
                                <i class="fa-solid fa-lock"></i> Permanently Locked
                            </span>
                        </div>
                        <div>
                            <p class="text-sm text-gray-400">Locked At</p>
                            <p class="text-gray-800 font-bold mt-1">
                                <?= !empty($user['permanently_locked_at']) ? date('d/m/Y - H:i', strtotime($user['permanently_locked_at'])) : '-' ?>
                            </p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-400 font-medium">Wrong Logins</p>
                            <p class="text-red-600 font-bold mt-1"><?= h($user['wrong_login_count'] ?? 0) ?> times</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <form method="POST" action="" class="flex-1 min-w-[180px] m-0" onsubmit="return confirm('Do you want to unlock and verify this account?');">
                        ...
                        <button type="submit" class="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-semibold py-3 px-4 rounded-xl flex items-center justify-center gap-2 transition-colors duration-200">
                            <i class="fa-regular fa-circle-check"></i> Unlock & Verify Account
                        </button>
                    </form>
                    
                    <form method="POST" action="" class="flex-1 min-w-[180px] m-0" onsubmit="return confirm('Are you sure you want to disable this account?');">
