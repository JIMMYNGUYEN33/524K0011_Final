    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-500 mt-1">Withdrawals and transfers awaiting approval (1)</p>
            </div>

            <div class="flex flex-col gap-4">
                
                <a href="AdTransactionsDetail.html" class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center justify-between cursor-pointer hover:shadow-md hover:border-purple-200 transition-all duration-200 group block">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h4 class="font-bold text-gray-900 group-hover:text-purple-600 transition-colors">Phan Nguyễn Thảo Như</h4>
                            <div class="flex items-center gap-4 text-sm text-gray-500 mt-1">
                                <span>Withdrawal (Rút tiền)</span>
                                <span>•</span>
                    ...
                    <div class="flex items-center gap-6">
                        <div class="text-right">
                            <div class="text-sm font-bold text-purple-600 mb-1.5">- 2.000.000 VND</div>
