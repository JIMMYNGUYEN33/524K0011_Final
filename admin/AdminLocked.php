...
<head>
    ...
    <title>Locked Accounts - Admin Panel</title>
...
<body class="bg-gray-50 text-gray-800 font-sans h-screen flex flex-col overflow-hidden">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900">Locked Accounts</h1>
                <p class="text-gray-500 mt-1">Accounts temporarily locked (1)</p>
            </div>

            <div class="flex flex-col gap-4">
                
               <a href="AdLockedDetail.html" class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center justify-between cursor-pointer hover:shadow-md hover:border-orange-200 transition-all duration-200 group block">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h4 class="font-bold text-gray-900 group-hover:text-orange-600 transition-colors">Phan Nguyễn Thảo Như</h4>
            <div class="flex items-center gap-2 text-sm text-gray-500 mt-1">
                <span>lockeduser@gmail.com</span>
                <span>•</span>
